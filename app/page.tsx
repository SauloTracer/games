    ...
    <section className="mx-auto flex w-full max-w-4xl flex-col gap-8 rounded-[2rem] border border-white/60 bg-white/85 p-6 shadow-panel backdrop-blur md:p-10">
      ...
      <div className="space-y-4 text-center">
        ...
        <h1 className="text-4xl font-black tracking-tight text-stone-900 md:text-6xl">
          Sudoku, rebuilt in Next.js
        </h1>
        <p className="mx-auto max-w-2xl text-base leading-7 text-stone-600 md:text-lg">
          The Vue application has been translated into a React-based app with
          App Router, TypeScript, Tailwind, responsive ads, and a fully playable
          Sudoku board.
        </p>
      </div>
